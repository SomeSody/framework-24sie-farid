...
@section('content')
    <div class="py-4">
        ...
        <div class="d-flex justify-content-between w-100 flex-wrap">
            ...
            <div>
                <a href="{{ route('product.index') }}" class="btn btn-primary"><i class="far fa-question-circle me-1"></i>
                    Kembali</a>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12 mb-4">
            ...
            {{-- <div>
                        <a href="{{route('product.index')}}"  class="btn btn-primary"><i class="far fa-question-circle me-1"></i> Kembali</a>
                    </div> --}}
